...
mod tests {
    ...
    fn it_correctly_parses_a_section0() {
        let cursor = Cursor::new([0x00, 0x00, 0x00, 0x1B, 0x02, 0xFE, 0x00, 0x07, 0xE6, 0x04, 0x11, 0x00, 0x29, 0x38, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01]);
