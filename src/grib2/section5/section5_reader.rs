...
impl Section5Reader {
    pub fn read(reader: &mut impl Read) -> Result<Section5, Grib2Error> {
        ...
        let data_representation_template =
            Section5Reader::read_data_representation_template(reader, tpl_number, length - 11)?;
...
mod tests {
    ...
    fn it_correctly_parses_section5() {
        let mut reader = BufReader::new(Cursor::new([
            0x00, 0x00, 0x00, 0x15, 0x05, 0x00, 0x0B, 0x84, 0xAE, 0x00, 0x00, 0x00, 0x00, 0x00,
            0x00, 0x80, 0x0F, 0x00, 0x00, 0x10, 0x00,
        ]));
        ...
        match section5.data_representation_template {
            ...
            _ => panic!(
                "wrong data representation template {:?}",
                section5.data_representation_template
            ),
        };
    ...
    fn it_correctly_parses_a_section5_for_data_rep_tpl_23774() {
        let mut reader = BufReader::new(Cursor::new([
            0x00, 0x00, 0x00, 0x15, 0x05, 0x00, 0x0B, 0x84, 0xAE, 0x00, 0x00, 0xC2, 0x4F, 0xBA,
            0x60, 0x80, 0x03, 0x00, 0x00, 0x10, 0x00,
        ]));
