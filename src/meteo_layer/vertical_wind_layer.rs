...
pub struct DwdVerticalWindLayer<'a> {
...
impl <'a> DwdVerticalWindLayer<'a> {
    pub fn new(
        ...
        return DwdVerticalWindLayer { hhl_grids, u_grids, v_grids };
    }
    ...
    pub fn get_lat_lon_extent(&self) -> &LatLonExtent {
        return self.u_grids.get(0).unwrap().get_grid_lat_lon_extent();
    }
