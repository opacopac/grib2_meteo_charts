...
use meteo_grib2_renderer::meteo_chart::forecast_renderer::wind_10m_chart_renderer::Wind10mChartRenderer;
...
pub fn read_test_wind_layer() -> MeteoWind10mLayer {
...
fn it_creates_an_image_from_a_wind_layer_with_the_correct_dimensions() {
    ...
    let result = Wind10mChartRenderer::render_full_chart(&layer);
