...
use meteo_grib2_renderer::meteo_chart::meteo_layer::meteo_hhl_layer::MeteoHhlLayer;
...
fn it_successfully_reads_a_hhl_test_file() {
    let doc = FileToGridConverter::read_single_doc_from_file_or_url(HHL_TEST_FILE).unwrap();
